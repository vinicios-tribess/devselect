...
A proposta se refere a uma solução para melhorar o processo de seleção de programas de treinamento para a área de desenvolvimento. <br/>
...
O grupo apresenta como solução o DevsSelect. Uma ferramenta que irá facilitar o processo de seleção de candidatos. <br/> <br/>
